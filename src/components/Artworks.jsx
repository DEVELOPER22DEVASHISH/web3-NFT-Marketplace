...
const Artworks = () => {
    ...
    const [end, setEnd] = useState(4) // enable how many nft will be show
  ...
  return (
    <div className='bg-[#151c25] gradient-bg-artworks'>
        <div className='w-4/5 py-10 mx-auto'>
            ...
            {collection.length > 0 && nfts.length > collection.length ? (<div className='text-center my-5'>
...
const Card = ( {nft}) => {
    ...
    return (
    <div className='w-full shadow-xl shadow-black rounded-md overflow-hidden bg-gray-800 my-3 p-3'>
        <img className='h-60 w-full object-cover shadow-black rounded-lg mb-3' src={nft.metadataURI} alt={nft.title}/>

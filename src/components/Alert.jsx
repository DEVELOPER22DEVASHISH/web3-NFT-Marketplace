...
const Alert = () => {
  ...
  return (
    <div className={`fixed top-0 left-0 w-screen h-screen flex items-center bg-black bg-opacity-50 transform transition-transform duration-300 ${alert.show ? 'scale-100' : 'scale-0'}`}>
...
// npm start // ganache-cli -d // truffle migrate